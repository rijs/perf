...
Extends the [rendering pipeline](#ripple-draw) to log out time taken for render of every component to help with fine-tuning by highlighting performance bottlenecks. Should only be used in development.